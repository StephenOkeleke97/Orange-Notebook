    ...
    onPress={() => Keyboard.dismiss()}>
        <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.headerText}>Enter the email associated with your account and we'll send
                    an email with a verification code that will be required to 
                    reset your password.
                </Text>
            </View>
            <View style={styles.emailInputContainer}>
                <Text style={styles.headerText}>Email address</Text>
                <TextInput style={styles.emailInput} autoCapitalize="none"
                placeholder='Email'
                value={email} onChangeText={(e) => {
                    setEmailIsError(false);
                    setEmail(e);
                }}/>
                {emailIsError && <Text style={styles.errorText}>Please enter a valid email</Text>}

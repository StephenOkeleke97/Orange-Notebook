...
export default function NoteCardSlim({ id, title, content, category, label, date, getSelectMode, setSelectMode,
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={[styles.cardContainer, {backgroundColor: `rgba(${redColor}, ${greenColor}, ${blueColor}, 0.2)`}]}
            onPress={() => noteClick()}
            activeOpacity={0.6}
